...
--
-- Name: scraper_scrapeddata; Type: TABLE; Schema: public; Owner: myuser
--

CREATE TABLE public.scraper_scrapeddata (
    id bigint NOT NULL,
...
ALTER TABLE public.scraper_scrapeddata OWNER TO myuser;

--
-- Name: scraper_scrapeddata_id_seq; Type: SEQUENCE; Schema: public; Owner: myuser
--

ALTER TABLE public.scraper_scrapeddata ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.scraper_scrapeddata_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
25	Can add scraped data	7	add_scrapeddata
26	Can change scraped data	7	change_scrapeddata
27	Can delete scraped data	7	delete_scrapeddata
28	Can view scraped data	7	view_scrapeddata
\.
...
1	contenttypes	0001_initial	2024-09-28 09:05:09.934966+06
2	auth	0001_initial	2024-09-28 09:05:09.991581+06
3	admin	0001_initial	2024-09-28 09:05:10.007122+06
4	admin	0002_logentry_remove_auto_add	2024-09-28 09:05:10.011756+06
5	admin	0003_logentry_add_action_flag_choices	2024-09-28 09:05:10.016947+06
6	contenttypes	0002_remove_content_type_name	2024-09-28 09:05:10.028489+06
7	auth	0002_alter_permission_name_max_length	2024-09-28 09:05:10.035118+06
8	auth	0003_alter_user_email_max_length	2024-09-28 09:05:10.040677+06
9	auth	0004_alter_user_username_opts	2024-09-28 09:05:10.046415+06
10	auth	0005_alter_user_last_login_null	2024-09-28 09:05:10.054265+06
11	auth	0006_require_contenttypes_0002	2024-09-28 09:05:10.055773+06
12	auth	0007_alter_validators_add_error_messages	2024-09-28 09:05:10.060929+06
13	auth	0008_alter_user_username_max_length	2024-09-28 09:05:10.069998+06
14	auth	0009_alter_user_last_name_max_length	2024-09-28 09:05:10.075568+06
15	auth	0010_alter_group_name_max_length	2024-09-28 09:05:10.083244+06
16	auth	0011_update_proxy_permissions	2024-09-28 09:05:10.088491+06
17	auth	0012_alter_user_first_name_max_length	2024-09-28 09:05:10.095211+06
18	scraper	0001_initial	2024-09-28 09:05:10.105965+06
19	sessions	0001_initial	2024-09-28 09:05:10.11757+06
20	scraper	0002_scrapeddata_description	2024-09-28 12:49:59.159415+06
\.
...
--
-- Data for Name: scraper_scrapeddata; Type: TABLE DATA; Schema: public; Owner: myuser
--

COPY public.scraper_scrapeddata (id, url, title, scraped_at, description) FROM stdin;
15	https://www.aplusproducts.net/	High-Quality Plastic & Metal Fasteners for Retail Manufacturers • A+ Products, Inc.	2024-09-28 12:57:19.242609+06	We produce high-quality, weather tested plastic and metal fasteners for retail brands. Wholesale discounts available.
16	https://www.wikipedia.org/	Wikipedia	2024-09-28 12:59:46.545589+06	Wikipedia is a free online encyclopedia, created and edited by volunteers around the world and hosted by the Wikimedia Foundation.
17	https://github.com/	GitHub: Let’s build from here · GitHub	2024-09-28 13:00:38.41468+06	GitHub is where over 100 million developers shape the future of software, together. Contribute to the open source community, manage your Git repositories, review code like a pro, track bugs and features, power your CI/CD and DevOps workflows, and secure code before you commit it.
18	https://www.bbc.com/news	Home - BBC News	2024-09-28 13:01:09.723196+06	Visit BBC News for up-to-the-minute news, breaking news, video, audio and feature stories. BBC News provides trusted World and UK news as well as local and regional perspectives. Also entertainment, business, science, technology and health news.
19	https://openweathermap.org/	Current weather and forecast - OpenWeatherMap	2024-09-28 13:02:32.348135+06	OpenWeather provides comprehensive weather data services, including current, forecast, and historical\nweather information. Explore a wide range of APIs for solar radiation, road risk assessment, solar energy prediction,\nand more, with global coverage and user-friendly access. Ideal for developers and businesses seeking accurate and\nreliable weather insights.
20	https://www.nasa.gov/	NASA	2024-09-28 13:03:49.895595+06	NASA.gov brings you the latest news, images and videos from America's space agency, pioneering the future in space exploration, scientific discovery and aeronautics research.
21	https://www.usa.gov/	Making government services easier to find | USAGov	2024-09-28 13:05:25.261467+06	Find government benefits, services, agencies, and information at USA.gov. Contact elected officials. Learn about passports, Social Security, taxes, and more.
\.
...
--
-- Name: scraper_scrapeddata_id_seq; Type: SEQUENCE SET; Schema: public; Owner: myuser
--

SELECT pg_catalog.setval('public.scraper_scrapeddata_id_seq', 21, true);
...
--
-- Name: scraper_scrapeddata scraper_scrapeddata_pkey; Type: CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.scraper_scrapeddata
    ADD CONSTRAINT scraper_scrapeddata_pkey PRIMARY KEY (id);


--
-- Name: scraper_scrapeddata scraper_scrapeddata_url_key; Type: CONSTRAINT; Schema: public; Owner: myuser
--

ALTER TABLE ONLY public.scraper_scrapeddata
    ADD CONSTRAINT scraper_scrapeddata_url_key UNIQUE (url);
...
--
-- Name: scraper_scrapeddata_url_a54398ae_like; Type: INDEX; Schema: public; Owner: myuser
--

CREATE INDEX scraper_scrapeddata_url_a54398ae_like ON public.scraper_scrapeddata USING btree (url varchar_pattern_ops);
